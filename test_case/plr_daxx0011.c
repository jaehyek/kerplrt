...
int initialize_daxx_0011( uchar * buf, uint test_area_start, uint test_area_length )
{
	int ret = 0;
...
int read_daxx_0011(uchar * buf, uint test_area_start, uint test_area_length)
{
...
int write_daxx_0011(uchar * buf, uint test_area_start, uint test_area_length)
{
