...
#elif defined(CONFIG_MACH_YSE7420)
const u64 	TICK_RES_NS  		= 41LL; 		// uset is nano second
const u64 	TICK_RES_NS_INV  	= 24000000LL;	// inverse of TICK_RES_NS		// 24 Mhz
////////////////////////////////////////////////////////////////////////////////////

#elif defined(HARDWARE_LG)

//1.2 For LG  system, 1 tick = 52 ns, 
const u64	TICK_RES_NS  		= 52LL;			// uset is nano second
const u64	TICK_RES_NS_INV 	= 19200000LL;	// inverse of TICK_RES_NS	// 19.2 Mhz
////////////////////////////////////////////////////////////////////////////////////

// ...
#else //for system

const u64 	TICK_RES_NS  		= 30518LL;
const u64 	TICK_RES_NS_INV  	= 32768LL;
#endif
